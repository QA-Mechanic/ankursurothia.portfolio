...
function App() {
  const [theme] = useState('vibrant');
  const [loading, setLoading] = useState(true);

  useEffect(() => {
    // Update document title and meta tags
    document.title = "Ankur Surothia - Senior QA Automation Engineer";
    
    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute('content', 
        'Senior QA Automation Engineer with 12+ years of experience in test automation, API testing, and CI/CD. Expert in Selenium, Playwright, Java, Python.'
      );
    }
      ...
      <Navigation />
        ...
        <div className="topbar">
          <div className="social-links">
            ...
            <a 
              href="https://www.linkedin.com/in/ankur-surothia/" 
              target="_blank" 
              rel="noopener noreferrer" 
